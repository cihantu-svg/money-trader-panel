...
def causal_pivot_exists(high, low, left, right):
    ...
    SADECE right bar sonra onaylanir (repaint yok - request.security/lookahead
    KULLANILMIYOR, sadece kapanmis 1dk barlarindan hesaplaniyor).
    fixnan davranisi BIREBIR korundu: bir kez pivot olustu mu, 'var' bayragi
    KALICIDIR (orijinal Pine'daki gibi - sonradan degistirilmedi)."""
    window = left + right + 1
