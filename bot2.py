...
- YENI: coin'in son 24s USDT hacmi MIN_QUOTE_VOLUME_24H altindaysa sinyal uretilmez (dusuk likidite elenir)
...
def analyze_symbol(symbol, quote_volumes=None):
    # --- YENI: likidite kontrolu once yapilir, dusukse hic kline cekmeye gerek yok ---
...
def run_scan_parallel():
    ...
    # YENI: likidite verisi TEK istekte, tarama basinda bir kez cekilir (600 ayri istek yerine 1 istek)
